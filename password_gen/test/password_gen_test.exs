defmodule PasswordGenTest do
  ...
  test "returns string with symbols", %{options_type: options} do
    ...
    {:ok, result} = PasswordGen.generate(options_with_symbols)
  ...
  test "returns string with all inculded options", %{options_type: options} do
    ...
    {:ok, result} = PasswordGen.generate(options_All_included)
